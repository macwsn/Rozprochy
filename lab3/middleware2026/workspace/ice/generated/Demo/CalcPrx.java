...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return _iceI_avgAsync(list, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] list, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(list, context, false);
    }
